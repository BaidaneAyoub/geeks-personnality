...
--
-- Host: 127.0.0.1    Database: geeks_db
-- ------------------------------------------------------
-- Server version	8.0.44
CREATE DATABASE IF NOT EXISTS geeks_db;
USE geeks_db;
...
CREATE TABLE `answers` (
  ...
  CONSTRAINT `answers_chk_1` CHECK ((`answer` between -(3) and 3))
...
CREATE TABLE `questions` (
  ...
  `text` text,
  `category` enum('EI','NS','TF','JP') NOT NULL,
...
CREATE TABLE `results` (
  ...
  `user_id` int DEFAULT NULL,
  `personality_code` varchar(10) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`result_id`),
  KEY `user_id` (`user_id`),
  KEY `personality_code` (`personality_code`),
  CONSTRAINT `results_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `results_ibfk_2` FOREIGN KEY (`personality_code`) REFERENCES `personality` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-01 13:35:40
